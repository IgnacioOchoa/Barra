...
public:
    ...
    virtual QList<ElementoAbstracto*> getElementos() const = 0;
    virtual void moverNodo(QList<float> deltas) = 0;
    virtual void reubicarNodo(QList<float> pos) = 0;
    virtual bool conectarElemento(ElementoAbstracto* el) = 0;
    virtual bool desconectarElemento(ElementoAbstracto* el) = 0;
